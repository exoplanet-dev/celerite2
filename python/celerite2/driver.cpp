...
PYBIND11_MODULE(driver, m) {
  ...
  m.def("factor", &celerite2::driver::factor, "Compute the Cholesky factor of a celerite system", py::arg("t").noconvert(), py::arg("c").noconvert(),
        py::arg("U").noconvert(), py::arg("d").noconvert(), py::arg("W").noconvert());
  m.def("solve", &celerite2::driver::solve, "Solve a celerite system using the output of `factor`", py::arg("t").noconvert(),
        py::arg("c").noconvert(), py::arg("U").noconvert(), py::arg("d").noconvert(), py::arg("W").noconvert(), py::arg("Z").noconvert());
  m.def("norm", &celerite2::driver::norm, "Compute the norm of a celerite system applied to a vector", py::arg("t").noconvert(),
        py::arg("c").noconvert(), py::arg("U").noconvert(), py::arg("d").noconvert(), py::arg("W").noconvert(), py::arg("z").noconvert());
  m.def("matmul", &celerite2::driver::matmul, "Dot a celerite system into a matrix or vector", py::arg("t").noconvert(), py::arg("c").noconvert(),
        py::arg("a").noconvert(), py::arg("U").noconvert(), py::arg("W").noconvert(), py::arg("Y").noconvert(), py::arg("Z").noconvert());
  m.def("dot_tril", &celerite2::driver::dot_tril, "Dot the Cholesky factor celerite system into a matrix or vector", py::arg("t").noconvert(),
        py::arg("c").noconvert(), py::arg("U").noconvert(), py::arg("d").noconvert(), py::arg("W").noconvert(), py::arg("Z").noconvert());
