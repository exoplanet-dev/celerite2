...
PYBIND11_MODULE(xla_ops, m) {
    m.def("factor", []() {
        return encapsulate_function(factor);
    });
    m.def("factor_rev", []() {
        return encapsulate_function(factor_rev);
    });
    m.def("solve_lower", []() {
        return encapsulate_function(solve_lower);
    });
    m.def("solve_lower_rev", []() {
        return encapsulate_function(solve_lower_rev);
    });
    m.def("solve_upper", []() {
        return encapsulate_function(solve_upper);
    });
    m.def("solve_upper_rev", []() {
        return encapsulate_function(solve_upper_rev);
    });
    m.def("matmul_lower", []() {
        return encapsulate_function(matmul_lower);
    });
    m.def("matmul_lower_rev", []() {
        return encapsulate_function(matmul_lower_rev);
    });
    m.def("matmul_upper", []() {
        return encapsulate_function(matmul_upper);
    });
    m.def("matmul_upper_rev", []() {
        return encapsulate_function(matmul_upper_rev);
    });
    m.def("general_matmul_lower", []() {
        return encapsulate_function(general_matmul_lower);
    });
    m.def("general_matmul_upper", []() {
        return encapsulate_function(general_matmul_upper);
    });
}
