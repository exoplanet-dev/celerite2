...
TEMPLATE_LIST_TEST_CASE("check the results of solve_upper_rev", "[solve_upper_rev]", TestKernels) {
  SETUP_TEST(10);
  ...
  auto rev = [](auto x, auto c, auto U, auto W, auto Y, auto Z, auto F, auto bZ, auto bx, auto bc, auto bU, auto bW, auto bY) {
    solve_upper_rev(x, c, U, W, Y, Z, F, bZ, bx, bc, bU, bW, bY);
